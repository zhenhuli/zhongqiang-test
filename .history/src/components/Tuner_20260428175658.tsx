          ...
          <div className="flex items-center justify-center mb-4 h-6">
            {isListening ? (
              ...
              <>
                ...
                <span className="text-gray-600 text-sm">未开始监听</span>
              </>
            )}
          </div>
          ...
          <div className="h-44 flex flex-col items-center justify-center">
            {isListening && currentNote ? (
              ...
              <div className="flex flex-col items-center justify-center w-full">
                {/* 音高显示 - 大字 */}
                <div className="flex items-end justify-center mb-2 h-32">
                  <span
              ...
              <div className="flex flex-col items-center justify-center w-full h-full">
                {/* 大字占位 - 透明，保持高度 */}
                <div className="flex items-end justify-center mb-2 h-32">
                  <span className="text-7xl md:text-9xl font-bold text-transparent">--</span>
                </div>

                {/* 频率占位 - 透明 */}
                <div className="text-xl text-transparent mb-2 h-7">-- Hz</div>

                {/* 状态标签占位 - 显示提示 */}
                <div className="h-12 flex items-center justify-center">
                  <div className="inline-flex items-center px-6 py-3 rounded-full text-lg font-medium bg-gray-100 text-gray-500">
                    <svg
                      className="w-6 h-6 mr-2"
                      fill="none"
                      stroke="currentColor"
              ...
              <div className="flex flex-col items-center justify-center w-full h-full">
                ...
                {/* 状态标签占位 - 显示提示 */}
                <div className="h-12 flex items-center justify-center">
                  <div className="inline-flex items-center px-6 py-3 rounded-full text-lg font-medium bg-primary/10 text-primary">
                    <svg
                      className="w-6 h-6 mr-2"
                      fill="none"
                      stroke="currentColor"
